...
> npx @playwright/mcp@latest --help
  ...
  --log-requests               enable network request/response logging to disk
  --log-session-id             emit the browser session id into tool responses
                               and stderr logs
...
- **browser_click**
  ...
  - Parameters:
    ...
    - `selector` (string, optional): Optional Playwright selector used when ref is unavailable or stale
...
- **browser_evaluate**
  ...
  - Parameters:
    ...
    - `ref` (string, optional): Exact target element reference from the page snapshot
    - `selector` (string, optional): Optional Playwright selector used when ref is unavailable or omitted
  - Read-only: **false**
...
- **browser_fill_form**
  ...
  - Parameters:
    - `fields` (array): Form fields to fill or select in sequence
  - Read-only: **false**
