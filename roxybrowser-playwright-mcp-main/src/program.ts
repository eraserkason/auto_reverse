...
program
    ...
    .option('--log-requests', 'enable network request/response logging to disk')
    .addOption(new Option('--log-requests-from-first-navigation', 'delay network logging until the first successful browser_navigate call').hideHelp())
    .option('--log-session-id', 'emit the browser session id into tool responses and stderr logs')
    ...
    .addOption(new Option('--no-roxy-mode', 'Disable RoxyBrowser dynamic connection mode').hideHelp())
